...
function HomeNavbar() {
  return (
    <div className="px-3 lg1:hidden pt-[20px] pb-[20px] border-b-[1px] border-black">
      <nav className="w-[100%] flex items-center justify-evenly">
        <div className="w-[20%] flex justify-center">
          <h2
            className="text-[22px] font-[700] text-[#2575ed] "
        ...
        <div className="w-[60%]">
          <ul className="text-[16px] font-[700] text-[#555555] flex w-full justify-center">
            <li className=" px-[20px] py-[5px] text-black hover:text-[#00CBFF]">
              <NavLink to="/"> HOME </NavLink>
            </li>
            <li className=" text-black  px-[20px] py-[5px] hover:text-[#00CBFF]">
